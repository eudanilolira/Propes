...
Rails.application.config.assets.precompile += %w( anamneses.js anamneses.scss)
Rails.application.config.assets.precompile += %w( bridge_extensions.js bridge_extensions.scss)
Rails.application.config.assets.precompile += %w( cutaneous_folds.js cutaneous_folds.scss)
Rails.application.config.assets.precompile += %w( y_tests.js y_tests.scss)